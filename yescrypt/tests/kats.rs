...
fn kat0() {
    ...
    let params = Params::new(Flags::empty(), 16, 1, 1);
...
fn kat2() {
    ...
    let params = Params::new(Flags::empty(), 4, 1, 1);
    let mut actual = [0u8; 64];
    yescrypt_kdf(b"", b"", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat3() {
    ...
    let params = Params::new(Flags::WORM, 4, 1, 1);
    let mut actual = [0u8; 64];
    yescrypt_kdf(b"", b"", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat5() {
    ...
    let params = Params::new_with_all_params(Flags::WORM, 4, 1, 1, 1, 0);
    let mut actual = [0u8; 64];
    yescrypt_kdf(b"", b"", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat6() {
    ...
    let params = Params::new_with_all_params(Flags::WORM, 4, 1, 1, 2, 0);
    let mut actual = [0u8; 64];
    yescrypt_kdf(b"", b"", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat7() {
    ...
    let params = Params::new_with_all_params(Flags::WORM, 4, 1, 1, 3, 0);
    let mut actual = [0u8; 64];
    yescrypt_kdf(b"", b"", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat12() {
    ...
    let params = Params::new(Flags::default(), 4, 1, 1);
    let mut actual = [0u8; 64];
    yescrypt_kdf(b"", b"", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat14() {
    ...
    let params = Params::new_with_all_params(Flags::default(), 4, 1, 1, 1, 0);
    let mut actual = [0u8; 64];
    yescrypt_kdf(b"", b"", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat19() {
    ...
    let params = Params::new_with_all_params(Flags::default(), 16, 8, 1, 10, 0);
...
fn kat20() {
    ...
    let params = Params::new_with_all_params(Flags::WORM, 16, 8, 1, 10, 0);
    let mut actual = [0u8; 40];
    yescrypt_kdf(b"p", b"s", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat21() {
    ...
    let params = Params::new(Flags::default(), 16, 8, 1);
    let mut actual = [0u8; 40];
    yescrypt_kdf(b"p", b"s", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
...
fn kat22() {
    ...
    let params = Params::new(Flags::WORM, 16, 8, 1);
    let mut actual = [0u8; 40];
    yescrypt_kdf(b"p", b"s", &params, &mut actual).unwrap();
    assert_eq!(EXPECTED.as_slice(), actual.as_slice());
}
