...
use hex_literal::hex;
use std::{mem, ptr};
use yescrypt::{yescrypt_init_local, yescrypt_kdf, Local, Params};

macro_rules! yescrypt_kat {
    (
        $name: ident,
        $passwd: expr,
        $salt: expr,
...
yescrypt_kat!(kat0, "", "", 0, 16, 1, 1, 0, 0, "77 d6 57 62 38 65 7b 20 3b 19 ca 42 c1 8a 04 97 f1 6b 48 44 e3 07 4a e8 df df fa 3f ed e2 14 42 fc d0 06 9d ed 09 48 f8 32 6a 75 3a 0f c8 1f 17 e8 d3 e0 fb 2e 0d 36 28 cf 35 e2 0c 38 d1 89 06");
yescrypt_kat!(kat1, "", "", 0, 16, 1, 1, 0, 0, "77 d6 57 62 38 65 7b 20");
yescrypt_kat!(kat2, "", "", 0, 4, 1, 1, 0, 0, "ef ad 0c 23 31 4c b5 72 bc 3c fb 15 43 da 42 f8 a8 b0 73 00 4c 86 6b 64 ab 50 55 a4 f0 9f a5 f5 71 14 2e bf e7 e0 5a 3b 92 c4 32 f3 1d ea 95 ad 5f 9c 85 4b 64 56 46 2f 4b d0 f7 32 b7 cd c5 49");
yescrypt_kat!(kat3, "", "", 1, 4, 1, 1, 0, 0, "85 dd a4 8c 9e c9 de 2f 7f 1a e8 b4 df ed a5 1f 8b 6d 56 f3 08 1b e1 a7 c0 83 3b a2 71 9a 36 ab 02 88 5d ae 36 55 7d 34 26 86 b1 7b a7 5f 2c 21 77 92 de 09 70 ab 1d 07 a9 c7 50 93 6d 31 42 6f");
yescrypt_kat!(kat4, "", "", 1, 4, 1, 1, 0, 0, "85 dd a4 8c 9e c9 de 2f");
yescrypt_kat!(kat5, "", "", 1, 4, 1, 1, 1, 0, "4b aa 8c d8 60 8b a9 1f 3e 34 39 d9 ec 4f ae 8f 9f c0 92 d9 ca 22 b7 37 7e 31 ae 5b 9a d7 87 7c 11 68 69 11 62 dd 0e 5e f0 49 e5 70 65 0c be d4 38 4a d6 05 34 fb 0c be d1 9f f3 f0 33 c9 4b 0c");
yescrypt_kat!(kat6, "", "", 1, 4, 1, 1, 2, 0, "e6 e8 bb a0 9b 64 12 ff b0 b3 cc 35 e3 7d 0b 78 2a 47 fb aa dc 57 a0 76 d7 c6 cc 2e 70 91 9a 1b 8d 47 38 c4 f8 33 55 69 07 42 d9 be d7 1c 3b 8f b0 d7 eb 08 6a b1 34 c5 e5 57 07 c2 c1 3c 75 ef");
