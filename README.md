# RustCrypto: password hashing [![Build Status](https://travis-ci.org/RustCrypto/password-hashes.svg?branch=master)](https://travis-ci.org/RustCrypto/password-hashes)
